...
Dialupは、Next.jsのような開発体験でWebSocketファーストのアプリケーションを
構築できるElixirフレームワークです。1つのページを監視されたサーバー側アクターとして扱い、
人間向けHTMLとAI Agent向けのスコープ付き意味/MCP面を同じ状態から投影します。
人間とAIは同じライブ状態と順序付きイベント列を共有します。
...
- **人間 → AI ハンドオフ** — スコープ付きMCPツール、意味focus、承認、双方向co-drive
...
- [Agent-nativeアプリ開発](./guides/agent-native-app-development.md) — 開発者・Coding Agent向け実装手順
- [人間 → AI ハンドオフ](./guides/agent-handoff.md) — 1つのライブセッションをエージェントと共有
