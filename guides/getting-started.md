...
`mix dialup.new` コマンドをグローバルに使えるよう、まず `dialup_new` をインストール：
...
| `app/about/page.ex` | `Dialup.App.About.Page` | `/about` |
| `app/users/[id]/page.ex` | `Dialup.App.Users.Id.Page` | `/users/:id` |
